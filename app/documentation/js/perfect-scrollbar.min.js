            ...
            function (t, e, n) {
                ...
                function r(t) {
                    ...
                    ;(r.settings = p.clone(c)),
                        ...
                        (r.scrollbarXBottom = p.toInt(
                            a.css(r.scrollbarXRail, 'bottom')
                        )),
                        ...
                        (r.railBorderXWidth =
                            p.toInt(
                                a.css(r.scrollbarXRail, 'borderLeftWidth')
                            ) +
                            p.toInt(
                                a.css(r.scrollbarXRail, 'borderRightWidth')
                            )),
                        ...
                        (r.scrollbarYRight = p.toInt(
                            a.css(r.scrollbarYRail, 'right')
                        )),
                        ...
                        (r.railBorderYWidth =
                            ...
                            p.toInt(
                                a.css(r.scrollbarYRail, 'borderBottomWidth')
                            )),
                ...
                l.initEvent('ps-scroll-up', !0, !0),
                    ...
                    (e.exports = function (t, e, n) {
                        ...
                        'top' === e &&
                            ...
                            ((t.scrollTop = n =
                                v.contentHeight - v.containerHeight),
                            t.dispatchEvent(b)),
                            'left' === e &&
                                n >= v.contentWidth - v.containerWidth &&
                                ((t.scrollLeft = n =
                                    v.contentWidth - v.containerWidth),
                                t.dispatchEvent(f)),
                            r || (r = t.scrollTop),
                            o || (o = t.scrollLeft),
