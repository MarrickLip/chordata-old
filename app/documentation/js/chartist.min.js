                        ...
                        for (var d = [], e = !0, f = 0; f < b.length; f += 2)
                            void 0 === c[f / 2].value
                                ...
                                : (e &&
                                      ...
                                      (e = !1)),
                                  d[d.length - 1].pathCoordinates.push(
                                      b[f],
                                      b[f + 1]
                                  ),
                        ...
                        if (h.length) {
                            if (h.length > 1) {
                                ...
                                return (
                                    h.forEach(function (a) {
                                        i.push(
                                            g(a.pathCoordinates, a.valueData)
                                        )
                                    }),
                                    c.Svg.Path.join(i)
                                )
                            ...
                            for (
                                ...
                                j
                                    ...
                                    : l || (n[0] = { x: +a[l], y: +a[l + 1] }),
                                    k.curve(
                                        (e * (-n[0].x + 6 * n[1].x + n[2].x)) /
                                            6 +
                                            f * n[2].x,
                                        (e * (-n[0].y + 6 * n[1].y + n[2].y)) /
                                            6 +
                                            f * n[2].y,
                                        (e * (n[1].x + 6 * n[2].x - n[3].x)) /
                                            6 +
                                            f * n[2].x,
                                        (e * (n[1].y + 6 * n[2].y - n[3].y)) /
                                            6 +
                                            f * n[2].y,
                                        n[2].x,
                                        n[2].y,
        ...
        (function (a, b, c) {
            ...
            function i(a, b, d, e, f) {
                ;(this.container = c.querySelector(a)),
                    ...
                    (this.supportsForeignObject = c.Svg.isSupported(
                        'Extensibility'
                    )),
