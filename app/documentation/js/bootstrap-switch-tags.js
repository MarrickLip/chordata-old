        ...
        BootstrapSwitch = (function () {
            function BootstrapSwitch(element, options) {
                    ...
                    class: (function (_this) {
                        return function () {
                            ...
                            if (_this.options.disabled) {
                                classes.push(
                                    _this.options.baseClass + '-disabled'
                                )
                            }
                            if (_this.options.readonly) {
                                classes.push(
                                    _this.options.baseClass + '-readonly'
                                )
                            }
                            if (_this.options.indeterminate) {
                                classes.push(
                                    _this.options.baseClass + '-indeterminate'
                                )
                            }
                            if (_this.options.inverse) {
                                classes.push(
                                    _this.options.baseClass + '-inverse'
                                )
                            }
                ...
                this.$element.on(
                    ...
                    (function (_this) {
                        return function () {
                            return _this.options.onInit.apply(
                                element,
                                arguments
                            )
                        }
                ...
                this.$element.on(
                    ...
                    (function (_this) {
                        return function (e) {
                            if (
                                false ===
                                _this.options.onSwitchChange.apply(
                                    element,
                                    arguments
                                )
                            ) {
            ...
            BootstrapSwitch.prototype._containerPosition = function (
                state,
                callback
            ) {
                if (state == null) {
                ...
                return this.$element.on({
                    ...
                    'previousState.bootstrapSwitch': (function (_this) {
                        return function (e) {
                            ...
                            return _this.$element
                                .prop('checked', _this.options.state)
                    ...
                    'change.bootstrapSwitch': (function (_this) {
                        return function (e, skip) {
                            ...
                            _this.$wrapper
                                .toggleClass(_this.options.baseClass + '-off')
                ...
                return this.$label.on({
                    ...
                    'mouseup.bootstrapSwitch touchend.bootstrapSwitch': (function (
                        ...
                        return function (e) {
                            ...
                            if (_this._dragEnd) {
                                state =
                                    _this._dragEnd > -(_this._handleWidth / 2)
                                _this._dragEnd = false
                                _this.state(
                                    _this.options.inverse ? !state : state
                                )
                            } else {
