...
;(function (global, factory) {
    ...
    var sweetHTML = (
        ...
        ' ' +
        iconTypes.warning +
        '"><span class="body pulse-warning-ins"></span><span class="dot pulse-warning-ins"></span></div>\n    <div class="' +
        swalClasses.icon +
        ' ' +
        iconTypes.info +
        '">i</div>\n    <div class="' +
            ...
            var onButtonEvent = function onButtonEvent(event) {
                ...
                switch (e.type) {
                    ...
                    case 'mouseup':
                        if (params.buttonsStyling) {
                            if (targetedConfirm) {
                                confirmButton.style.backgroundColor = colorLuminance(
                    ...
                    case 'radio':
                        ...
                        populateInputOptions = function populateInputOptions(
                            ...
                            for (var radioValue in inputOptions) {
                                ...
                                var radioLabelSpan = document.createElement(
                                    'span'
                                )
