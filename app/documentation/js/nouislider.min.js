...
!(function (a) {
    ...
    function S(c, e, i) {
        ...
        function H(a, b) {
            ia && (k(ia, e.cssClasses.active), (ia = !1)),
                a.cursor &&
        ...
        function I(a, b) {
            ...
            if (
                ((document.documentElement.noUiListeners = d.concat(f, g)),
                a.cursor)
            ) {
        ...
        function M(a, b, c, d, f) {
            return (
                ...
                e.padding &&
                    ...
                    b === ba.length - 1 && (c = Math.min(c, 100 - e.padding))),
                (c = ja.getStep(c)),
                (c = g(c)),
                c !== a[b] && c
            )
        ...
        function T(a, b) {
            null !== a &&
                ...
                (a = e.format.from(a)),
                a === !1 || isNaN(a) || Q(b, ja.toStepping(a), !1, !1))
        }
        function U(a, b) {
            var c = h(a),
                d = void 0 === ga[0]
        ...
        function _(a, b) {
            ...
            d.forEach(function (b) {
                ...
                (f.spectrum.direction = ja.direction),
                (ja = f.spectrum),
                (e.margin = f.margin),
                (e.limit = f.limit),
                (e.padding = f.padding),
