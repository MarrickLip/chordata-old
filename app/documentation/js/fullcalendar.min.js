...
!(function (t) {
	...
	function A(t, e) {
		...
		for (
			n = 0;
			n < Kt.length && ((i = Kt[n]), (r = V(i, t, e)), !(r >= 1 && ot(r)));
			n++
		);
		return i;
	}
										...
										(m = t(
											...
											.click(function (t) {
												m.hasClass(p + '-state-disabled') ||
													(a(t),
													(m.hasClass(p + '-state-active') ||
														m.hasClass(p + '-state-disabled')) &&
														m.removeClass(p + '-state-hover'));
											})
											.mousedown(function () {
											...
											.hover(
												...
												function () {
													m.removeClass(p + '-state-hover').removeClass(
														p + '-state-down'
													);
												}
											)),
	...
	function _t(n, i) {
		...
		function o() {
			...
			(W = new Vt(e)),
				...
				_.options.handleWindowResize &&
					((K = at(v, _.options.windowResizeDelay)), t(window).resize(K));
		}
		function l() {
			Q && Q.removeElement(),
		...
		function u(e, n) {
			...
			i && (F(), c()),
				!Q &&
					...
					Q.setElement(
						t("<div class='fc-view fc-" + e + "-view' />").appendTo(q)
					),
		...
		function V(t) {
			...
			if (1 === n) {
				...
				if ('businessHours' === e)
					return void (
						Q && (Q.unrenderBusinessHours(), Q.renderBusinessHours())
					);
				if ('timezone' === e)
		...
		(J =
			...
			(_.isHeightAuto = function () {
				return (
					'auto' === _.options.contentHeight || 'auto' === _.options.height
				);
			}),
	...
	function Ut() {
		...
		function u(t, e) {
			var n, i;
			for (
				'reset' === e ? (nt = []) : 'add' !== e && (nt = C(nt, t)), n = 0;
				n < t.length;
				n++
			)
				(i = t[n]),
		...
		function f(e, n) {
			...
			for (i = 0; i < s.length; i++) {
				if (
					((r = s[i].call(U, e, q.clone(), Z.clone(), U.options.timezone, n)),
					r === !0)
				)
					return;
			...
			for (s = 0; s < t.length; s++)
				if ((r = F(t[s]))) {
					for (n = _(r), o = 0; o < n.length; o++)
						(l = n[o]),
							l.source || (e && (Q.events.push(l), (l.source = Q)), nt.push(l));
					a = a.concat(n);
				}
			return a.length && i(), a;
		}
		...
		function F(n, i) {
			...
			if (
				...
				s && ((s = U.moment(s)), s.isValid() || (s = null)),
					(o = n.allDay),
					void 0 === o &&
						(o = J(i ? i.allDayDefault : void 0, U.options.allDayDefault)),
					A(r, s, o, l);
			}
	...
	var ue = (qt.EmitterMixin = {
		...
		he = St.extend(ce, {
			...
			position: function () {
				...
				(r = o.top || 0),
					(s =
						void 0 !== o.left ? o.left : void 0 !== o.right ? o.right - a : 0),
		...
		fe = (qt.CoordCache = St.extend({
			...
			queryBoundingRect: function () {
				var t;
				return this.els.length > 0 && ((t = d(this.els.eq(0))), !t.is(document))
					? f(t)
					: null;
			},
		...
		ge = (qt.DragListener = St.extend(ce, de, {
			...
			handleMove: function (t) {
				...
				this.isDistanceSurpassed ||
					((e = n * n + i * i), e >= r * r && this.handleDistanceSurpassed(t)),
	...
	ge.mixin({
		...
		initAutoScroll: function () {
			...
			(this.isAutoScroll =
				...
				this.isAutoScroll &&
					this.listenTo(t, 'scroll', at(this.handleDebouncedScroll, 100));
		},
					...
					l = new pe(this, {
						...
						hitOver: function (i, o, l) {
							l &&
								(o || (t = null),
								r &&
									((e = n.computeSelection(n.getHitSpan(l), n.getHitSpan(i))),
						...
						interactionEnd: function (r, s) {
							s ||
								(t &&
									!n.isIgnoringMouse &&
									i.triggerDayClick(n.getHitSpan(t), n.getHitEl(t), r),
					...
					delete t.component,
						n.stop(!i, function () {
							e && (l.unrenderDrag(), r.segDragStop(t, s)),
								i ? l.reportEventDrop(c, i, r.largeUnit, u, s) : l.showEvent(c);
						}),
				...
				u = (r.externalDragListener = new pe(this, {
					...
					hitOver: function (t) {
						(i = r.computeExternalDrop(t.component.getHitSpan(t), a)),
							i &&
								!l.isExternalSpanAllowed(r.eventToSpan(i), i, a.eventProps) &&
								(s(), (i = null)),
							i && r.renderDrag(i);
					},
					hitOut: function () {
				...
				h = (this.segResizeListener = new pe(this, {
					...
					hitOver: function (n, o, u) {
						...
						(i = e
							...
							i &&
								(a.isEventSpanAllowed(r.eventToSpan(i), c)
									? i.start.isSame(c.start.clone().stripZone()) &&
					...
					interactionEnd: function (e) {
						n && r.segResizeStop(t, e),
							i ? l.reportEventResize(c, i, r.largeUnit, u, e) : l.showEvent(c),
	...
	var ye = (qt.DayTableMixin = {
		...
		Se = (qt.DayGrid = me.extend(ye, {
			...
			renderDrag: function (t, e) {
				if (
					(this.renderHighlight(this.eventToSpan(t)), e && e.component !== this)
				)
		...
		Se.mixin({
			...
			limitRows: function (t) {
				...
				for (e = 0; e < i.length; e++)
					this.unlimitRow(e),
						(n =
							!!t && ('number' == typeof t ? t : this.computeRowLevelLimit(e))),
					...
					.on('click', function (o) {
						...
						'function' == typeof l &&
							...
							'popover' === l
								...
								: 'string' == typeof l && s.calendar.zoomTo(a, l);
					});
			},
						...
						hide: function () {
							if (o.popoverSegs)
								for (var t, e = 0; e < o.popoverSegs.length; ++e)
									(t = o.popoverSegs[e]),
										l.publiclyTrigger('eventDestroy', t.event, t.event, t.el);
	...
	var Ee = (qt.View = St.extend(ue, ce, {
			...
			discardScroll: function () {
				return (
					!--this.capturedScrollDepth && ((this.capturedScroll = null), !0)
				);
			},
			...
			bindEvents: function () {
				...
				this.isEventsBound ||
					...
					this.rejectOn('eventsUnbind', this.requestEvents()).then(function (
						e
					) {
				...
				!!i.class &&
					(s &&
						...
						s.valueOf() &&
							((i.duration = s),
							(o = A(s)),
							1 === s.as(o) && ((i.singleUnit = o), c.unshift(l[o] || {})))),
					(i.defaults = n(u)),
					(i.overrides = n(c)),
	...
	(De.prototype.normalizeEvent = function (t) {}),
		...
		(De.prototype.isEventSpanAllowed = function (t, e) {
			...
			return (
				...
				(!this.options.eventAllow || this.options.eventAllow(t, e) !== !1)
			);
		}),
			...
			for (r = 0; r < n.length; r++)
				(s = n[r]),
					(i && !s.dow) ||
						...
						l.push.apply(
							l,
							this.expandEvent(this.buildEventFromInput(s), o.start, o.end)
						));
			return l;
		});
	...
	var Ae = Ee.extend({
		...
		Ve = me.extend({
			...
			spanToSegs: function (t) {
				for (
					var e, n = this.view, i = n.start.clone().time(0), r = 0, s = [];
					i < n.end;
			...
			renderSegList: function (e) {
				...
				for (n = 0; n < s.length; n++)
					if ((i = s[n]))
						for (
							l.append(
								this.dayHeaderHtml(this.view.start.clone().add(n, 'days'))
							),
